...
export default function SyntaxHighlight() {
  const state = useStore({
    // This is ugly, need to add multiline string support to Mitosis parsing
    code: "\
    // Code from: https://github.com/trekhleb/javascript-algorithms/blob/master/src/data-structures/disjoint-set/DisjointSet.js \
  ...
  return (
    ...
    >
      <div css={{ margin: '0 auto', width: '100%', maxWidth: '800px' }}>
        ...
        <pre innerHTML={hljs.highlightAuto(state.code).value} />
      </div>
    </div>
  );
}
